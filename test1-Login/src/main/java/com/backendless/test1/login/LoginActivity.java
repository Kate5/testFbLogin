package com.backendless.test1.login;
...
public class LoginActivity extends Activity
{
  ...
  public void onLoginWithFacebookButtonClicked()
  {
    ...
    facebookFieldsMapping.put( "favorite_teams", "favorite_teams" );
    facebookFieldsMapping.put( "email", "email" );
    facebookFieldsMapping.put( "education", "education" );
    facebookFieldsMapping.put( "sports", "sports" );
    facebookFieldsMapping.put( "events", "events" );


    List<String> facebookPermissions = new ArrayList<>();
    facebookPermissions.add( "email" );
    facebookPermissions.add( "user_education_history" );
